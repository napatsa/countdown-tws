  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-[100vh]">
      <div className="relative bg-black bg-opacity-50 p-[50px] max-w-[600px]">
        ...
        <b>ลักษณะ</b> : ทุ่งแห้งแล้ง เต็มไปด้วยโครงกระดูกต้นไม้และโรงนาเก่า
        <br />
        <br />
        <b>อดีต</b> : เคยเป็นแหล่งอาหารของทั้งภูมิภาค ก่อนจะถูกเชื้อไวรัสทำลาย{" "}
        <br />
        <br />
        <b>ผู้คน</b> : เกษตรกร, ครอบครัว, ชาวไร่ที่เปลี่ยนมาเป็นผู้รอด <br />
        <br />
        <b>จุดเด่น</b> : เชี่ยวชาญด้านการปลูกพืชและการเก็บเสบียง ชำนาญพื้นที่
        เปิดสงคราม กองโจรได้ดี มีแหล่งน้ำใต้ดินลับบางจุด <br />
        <br />
        <b>จุดอ่อน</b> : ถูกคุกคามเสมอจากกลุ่มอื่นที่ต้องการเสบียง
